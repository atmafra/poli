 ...
 */
extern int matrix_log_value (Matrix matrix,
                             const MIndex row, const MIndex column);
 ...
 */
extern int matrix_sum_all (Matrix matrix, const RValue value);
 ...
 */
extern int matrix_mult_all (Matrix matrix, const RValue value);
 ...
 */
extern int matrix_log_all (Matrix matrix);
 ...
 */
extern void matrix_info (const Matrix matrix, FILE * output_fd);
