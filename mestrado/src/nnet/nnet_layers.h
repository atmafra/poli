 ...
 */
extern int nnet_layer_set_vector_stats (Layer layer, VectorStats stats);
 ...
 */
extern int nnet_layer_stddev_vector (const Layer layer, Vector stddev_vector);
 ...
 *
 * Returns the inverse standard deviations associated to layer's units
 * as a vector
 */
extern int
