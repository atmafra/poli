 ...
 */
size_t swav_num_samples (const swav_type riff);
 ...
 */
size_t swav_samples_per_second (const swav_type riff);
 ...
 */
int swav_detect (char *file_name, int *detected);
 ...
 */
int swav_read (FILE * in_file, index_entry_type * entry);
 ...
 * to the given file
 */
int swav_write_header_info (FILE * out_file, const swav_type wave);
 ...
 */
int swav_get_sample_value (const swav_type riff, const size_t sample,
