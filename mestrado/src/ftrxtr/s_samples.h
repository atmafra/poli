 ...
 */
int create_index (index_list_type * index, const index_list_ptr parent_index);
 ...
 */
int destroy_index (index_list_type * index);
 ...
 */
int add_index_entry (index_list_type * index, const char *list_name,
                     const char *file_name, const index_entry_type parent,
                     const smp_entries_type data_type,
                     const cmp_real ini_time, const cmp_real inc_time,
                     const smp_num_samples ini_norm_time,
                     smp_index_pos * pos,
                     const smp_set_current_type set_current);
 ...
 */
int destroy_index_entry (index_list_type * index);
 ...
 */
int move_to_entry (index_list_type * index, const smp_index_pos pos,
 ...
 */
int set_current_entry_pos (index_list_type * index, const smp_index_pos pos);
 ...
 */
int set_current_entry (index_list_type * index, const index_entry_type entry);
 ...
 */
int switch_entries (index_list_type * index, const smp_index_pos pos1,
 ...
 */
int add_current_list_value (index_list_type * index, const cmp_complex value);
 ...
 */
int destroy_list (sample_list_type ** smp_list);
 ...
 */
int resize_list (sample_list_type ** smp_list, const smp_num_samples samples);
 ...
 */
int get_list_value (const sample_list_type smp_list,
 ...
 */
int add_list_value (sample_list_type ** smp_list, const cmp_complex value);
 ...
 */
void update_list_statistics (sample_list_type ** smp_list);
 ...
 */
int calculate_list_statistics (sample_list_type ** smp_list);
 ...
 */
int convert_complex_list_to_real (sample_list_type * smp_list);
